...
class AddCommentAnimePage extends StatefulWidget {
  const AddCommentAnimePage({
    Key? key,
  ...
  @override
  State<AddCommentAnimePage> createState() => _AddCommentAnimePageState();
}

class _AddCommentAnimePageState extends State<AddCommentAnimePage> {
  @override
            ...
            (!AnimeCommentsPageState.reply)
                ...
                : Padding(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          child: Text(AnimeCommentsPageState.reply
                              ? context.localeString('reply_to') +
                                  AnimeCommentsPageState
                                      .comments[AnimeCommentsPageState.select]
                                      .account
                                      .userName
                                      .toLowerCase()
                              : AnimeCommentsPageState.edit
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            AnimeCommentsPageState.select = 0;
                            setState(() {});
                          },
                          child: Padding(
                            padding:
                            ...
                            Expanded(
                              child: Padding(
                                padding:
                                    const EdgeInsets.symmetric(horizontal: 8.0),
                                child: TextField(
                                  enabled: !AnimeCommentsPageState.sending,
                                  // autofocus: true,
                                  maxLines: 5,
                                  ...
                                  onEditingComplete: widget
                                      ...
                                      : (widget.myController.text.isEmpty &&
                                              AnimeCommentsPageState.sending)
                                          ? () {
                                              null;
                                ...
                                : Padding(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      child: SizedBox(
                                        ...
                                        width: 40,
                                        child: Card(
                                            color: AnimeCommentsPageState.isFire
                                                ? Colors.yellow
                                                : Colors.transparent,
                                            shape: RoundedRectangleBorder(
                                                borderRadius:
                      ...
                      child: Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: Card(
                            ...
                            child: AnimeCommentsPageState.sending
                                ? LoadingGif(
                                    logo: false,
                                  )
                                : Icon(
