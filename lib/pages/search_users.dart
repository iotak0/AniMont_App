...
class _SearchUsersState extends State<SearchUsers> {
  ...
  getUsers(key) async {
    ...
    setState(() {
      users = body.map<Users>(fromJson).toList();
    });
    //loadAnime();
  }

  static Users fromJson(json) =>
      Users(json['name'].toString(), json['username'], json['avatar'],json['id']);
  @override
  void initState() {
    search.addListener(() {
                        ...
                        ? GestureDetector(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => ProfialPage(id: e.id,)));
                            },
                            child: Padding(
...
class Users {
  ...
  Users(this.name, this.username, this.avatar, this.id);
}
