...
// import 'package:anime_mont_test/widget/helper/new_player.dart';
...
//   @override
//   State<AnimePlayer> createState() => AnimePlayerState();
//   final String url;
...
//     var response = await Server.postRequest(add_anime, {
//       "anime_id": '${animeId}',
//     });
...
//                               ok
//                                   ? SizedBox(
//                                       // height: 240, child: NewPlayer(link: play)
//                                       //  AnimeVideoPlayer(
//                                       //   url: play,
//                                       //   context: context,
//                                       // ),
...
//                                                                                             admOpen(play2.replaceAll('0p', '${list[index]}p_1'), '$epName - { ${list[index]} } ');
//                                                                                           },
//                                                                                           onTap: () async {
//                                                                                             Navigator.pop(context);
//                                                                                             // final _url = downloadList[index - 1].url.replaceAll("(", '').replaceAll(")", '');
...
//                                                                                                 child: Text(
//                                                                                                   list[index] + "P",
//                                                                                                   style: TextStyle(color: customColor.primaryColor, fontWeight: FontWeight.bold, fontFamily: Locales.currentLocale(context).toString() == 'en' ? 'Angie' : 'SFPro', fontSize: 22),
//                                                                                                 ),
//                                                                                               ),
//                                                                                               Padding(
...
//                                                                                                       child: Text(
//                                                                                                         list[index] + "P" + "تحميل الحلقة بجودة ",
//                                                                                                         overflow: TextOverflow.ellipsis,
//                                                                                                         style: TextStyle(fontFamily: Locales.currentLocale(context).toString() == 'en' ? 'Angie' : 'SFPro', color: customColor.primaryColor, fontWeight: FontWeight.w600, fontSize: 15.5),
//                                                                                                       ),
//                                                                                                     ),
//                                                                                                     Text(""),
//                                                                                                     Container(
//                                                                                                       width: size.width - 100,
//                                                                                                       child: Text(
//                                                                                                         "اضغط ضغطة مطولة لتحميل الحلقة بواسطة تطبيق ADM.",
//                                                                                                         overflow: TextOverflow.ellipsis,
//                                                                                                         style: TextStyle(fontFamily: Locales.currentLocale(context).toString() == 'en' ? 'Angie' : 'SFPro', color: customColor.primaryColor, fontSize: 12.5),
//                                                                                                       ),
//                                                                                                     ),
//                                                                                                   ],
//                                                                                                 ),
...
//                                                                                   final _url = downloadList[index - 1].url.replaceAll("(", '').replaceAll(")", '');
//                                                                                   // admOpen(_url, '$epName[${downloadList[index].quality}]');
//                                                                                   admOpen(play, '$epName[${downloadList[index].quality}]');
//                                                                                 },
//                                                                                 onTap: () async {
//                                                                                   Navigator.pop(context);
//                                                                                   final _url = downloadList[index - 1].url.replaceAll("(", '').replaceAll(")", '');
...
//                                                                                                     style: TextStyle(color: customColor.primaryColor, fontWeight: FontWeight.w600, fontSize: 15.5),
//                                                                                                   ),
//                                                                                                 ),
//                                                                                                 Text(''),
//                                                                                                 Container(
...
//                                                                                                     style: TextStyle(color: customColor.primaryColor, fontSize: 12.5),
//                                                                                                   ),
//                                                                                                 ),
//                                                                                               ],
//                                                                                             ),
...
//                                                                                                       child: AnimePlayer(quality: '240', url: allEp[index].link),
//                                                                                                     ));
//                                                                                           });
//                                                                                       // Navigator.push(
//                                                                                       //     context,
...
//                                                                                             child: Text(
//                                                                                               allEp[index].numb,
//                                                                                               style: TextStyle(color: customColor.primaryColor, fontWeight: FontWeight.bold, fontFamily: Locales.currentLocale(context).toString() == 'en' ? 'Angie' : 'SFPro', fontSize: 25),
//                                                                                             ),
//                                                                                           ),
//                                                                                           Padding(
//                                                                                             padding: const EdgeInsets.only(left: 10),
...
//                                                     Positioned(
//                                                         child: Image.asset(
//                                                             'images/Light/Arrow - Right 3.png',
//                                                             matchTextDirection:
//                                                                 true,
//                                                             color: allEPCount >
//                                                                     eNP
