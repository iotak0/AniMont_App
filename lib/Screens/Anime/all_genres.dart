...
class AllGenres extends StatefulWidget {
  ...
  @override
  State<AllGenres> createState() => AllGenresState();
}
...
class AllGenresState extends State<AllGenres> {
  ...
  void initState() {
    getWebsiteData(
        'https://animetitans.com/anime/?genre%5B0%5D=${widget.genre.replaceAll(' ', '+').replaceAll('-', '+').replaceAll('_', '+')}');
    ...
    listController.addListener(() {
      if (listController.position.maxScrollExtent == listController.offset &&
        ...
        print('page$page');
        getWebsiteData(
            'https://animetitans.com/anime/?page=$page&genre%5B0%5D=${widget.genre.replaceAll(' ', '+').replaceAll('-', '+').replaceAll('_', '+')}');
      }
    });
    super.initState();
  }
