// import 'package:anime_mont_test/pages/models/comments.dart';
...
//   DateTime ntpStaticTime = DateTime.now();
//   addAnime() async {
//     print("AnimeId :   " +
...
//     var response = await Server.postRequest(addAnime_link, {
...
//     // } catch (e) {}
//     //refresh();
//     print("hhhjjjjjjjj $ntpTime");
//     var response = await Server.postRequest(addComment_link, {
//       "comment_anime": '${widget.animeId}',
//       "comment_cont": _myController.text,
//       "comment_time": ntpTime.toString(),
...
//   like(int id, int his_id) async {
//     var response = await Server.postRequest(like_link, {
//       "user_id": '${widget.myId}',
//       "comment_user": '$his_id',
//       "comment_id": '$id',
//       "comment_anime": '${widget.animeId}',
...
//   unLike(int id) async {
//     var response = await Server.postRequest(unLike_link, {
//       "user_id": '${widget.myId}',
//       "comment_id": '$id',
//     });
...
//   static Future<List<Comments>> getComments(var animeId, int myId) async {
...
//     var response = await Server.postRequest(deleteComment_link, {
//       "comment_anime": '${widget.animeId}',
//       "comment_id": '$id',
//     });
...
//     var response = await Server.postRequest(editComment_link, {
//       "comment_anime": '${widget.animeId}',
//       "comment_cont": '${_myController.text}',
//       "comment_fair": _myCommentFire == true ? "1" : "0",
//       "comment_id": '$id',
...
//   _loadStaticNPHTime() async {
//     final ntpTime1 = await NTP.now();
//     setState(() {
//       ntpStaticTime = ntpTime1;
//       //ntpTime = ntpTime.toUtc().toLocal();
//     });
//   }
...
//                                                                         MaterialPageRoute(
//                                                                             builder: (context) =>
//                                                                                 ProfialPage(myId: widget.myId,id: comments[index].commentUser, isMyProfile: false)));
//                                                                   },
//                                                                   child: Container(
//                                                                       width: 55,
//                                                                       height: 55,
...
//                                                                             fit: BoxFit.cover,
//                                                                             image: NetworkImage(
//                                                                               !comments[index].avatar.toString().startsWith("https") ? image2 + comments[index].avatar : comments[index].avatar,
//                                                                             )),
//                                                                         borderRadius:
...
//                                                                                                         child: widget.myId.toString() == comments[index].commentUser || isAdmin == true
//                                                                                                             ? Container(
//                                                                                                                 color: backgroundColor,
...
//                                                                                           fontSize: 15,
//                                                                                         ),
//                                                                                         onTap: (p1) => Navigator.push(context, MaterialPageRoute(builder: (context) => ProfialPage(myId: widget.myId,id: comments[index].commentUser, isMyProfile: false))),
//                                                                                         linkTypes: [
//                                                                                           LinkType.userTag,
//                                                                                           LinkType.hashTag
//                                                                                         ],
...
//                                                                                                         }
//                                                                                                       } else {
//                                                                                                         if (like(comments[index].replies.last.commentId, comments[index].commentUser) == true) {
//                                                                                                           setState(() {
//                                                                                                             comments[index].replies.last.isLiked = false;
//                                                                                                             comments[index].replies.last.likes -= 1;
//                                                                                                           });
...
//                                                                                                           }
//                                                                                                         } else {
//                                                                                                           if (like(e.commentId, e.commentUser) == true) {
//                                                                                                             setState(() {
//                                                                                                               e.isLiked = false;
//                                                                                                               e.likes -= 1;
//                                                                                                             });
