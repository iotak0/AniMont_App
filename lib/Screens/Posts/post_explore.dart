...
class PostsExplorePage extends StatefulWidget {
  const PostsExplorePage({super.key, required this.myId});
  final int myId;
  @override
  State<PostsExplorePage> createState() => PostsPageState();
}

class PostsPageState extends State<PostsExplorePage> {
  late int page;
  ...
  getPosts() async {
    final response = await http
        .get(Uri.parse("$all_posts?page=$page&user_id=${widget.myId}"))
        .catchError((erorr0) {
      isLoading = false;
      erorr = true;
      setState(() {});
